  ...
  return (
    ...
    <header>
         <nav className='grid grid-cols-12  border-b  border-theme-border-color'>
                    <div className="py-2 pl-3 col-span-10 lg:col-span-2 border-r border-theme-border-color">naveen-kumar</div>
                    ...
                    <div className='block col-span-2 lg:hidden text-end'><Button onClick={()=>setShowMenu((prev)=>!prev)}><MenuIcon /></Button></div>
        </nav>
    </header>
