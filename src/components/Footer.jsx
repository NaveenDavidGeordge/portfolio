...
const Footer = () => {
  return (
    <footer>
        <div className='flex justify-between border-t border-theme-border-color px-2'>
            <div className='flex'>
                <div className='pe-5 ps-2 py-2 border-r border-theme-border-color'>
                    find me in : 
                </div>
                <div className='px-5 py-2 border-r border-theme-border-color m-auto'>
